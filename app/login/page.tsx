    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4 pt-20 dark:bg-slate-950">
      <div className="w-full max-w-sm rounded-2xl border border-gray-200 bg-white p-8 shadow-sm dark:border-slate-700 dark:bg-slate-900">
        <div className="mb-6 text-center">
          ...
          <p className="mt-1 text-sm text-gray-500 dark:text-slate-400">Sign in to your NutriLife account</p>
        </div>
        ...
        <p className="mt-5 text-center text-xs text-gray-500 dark:text-slate-400">
          ...
          <Link href="/register" className="font-medium text-[#1A5C38] hover:underline dark:text-emerald-400">
            Create one free
          </Link>
        </p>
      </div>
