...
const translations = {
  te: {
    ...
    stats: [
      { value: '10,000+', label: 'కుటుంబాలు ఉపయోగించాయి' },
      { value: '6', label: 'ఉచిత ప్లాన్స్' },
      { value: '100%', label: 'తెలుగు వంటకాలు' },
    ],
  ...
  hi: {
    ...
    stats: [
      { value: '10,000+', label: 'परिवारों ने उपयोग किया' },
      { value: '6', label: 'मुफ्त प्लान्स' },
      { value: '100%', label: 'भारतीय व्यंजन' },
    ],
  ...
  en: {
    ...
    stats: [
      ...
      { value: '6', label: 'Free plans' },
      { value: '100%', label: 'Telugu cuisine' },
    ],
